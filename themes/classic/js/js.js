var questions = [
   {   text: 'De la lista de enunciados que aparecen a continuación señale tres (3) de ellos que según usted  reflejan más fielmente el sentido de la Misión de la Universidad.  En caso de no conocer la misión de la Universidad deje la pregunta en blanco y continúe en la pregunta 3', 
         id: '1', 
       type: 'single-select', 
